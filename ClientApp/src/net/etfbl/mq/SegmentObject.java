...
public class SegmentObject {
	...
	public SegmentObject(int recipientId, String segmentText, int segmentIndex, String messageId, int totalSegments,
			String senderUsername, LocalDateTime timeSent, int senderId) {
		super();
